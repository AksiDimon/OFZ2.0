...
export function ChartQuotes() {
  ...
  console.log('✅', ListData, calcsStrips, calcsStripsFromRedux);
...
//   filterPointsWithinBorder
  ...
  function handlePointerUp(event) {
    ...
    //вынес вычисления выбранной области в функцию оналежит в halperDates.js 
    const selectionMetrics = calcEmphasizeSquare(calcsStrips, selectionBox)
    dispatch(chartQuotesSlice.actions.setCalcsStrips(selectionMetrics))
